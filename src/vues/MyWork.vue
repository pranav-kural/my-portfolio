<template lang="html">
  <div id="myWork" class="uk-section">
    <div class="uk-container">
      <h1 class="uk-heading-divider uk-text-center">MY WORK</h1>
      <div>
        <ul class="uk-child-width-expand" uk-tab>
          <li class="uk-active"><a href="" v-on:click="selectedLanguage = 'all'">ALL</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'JavaScript'">JavaScript</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'NodeJS'">NodeJS</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'C#'">C#</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'Java'">Java</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'PHP'">PHP</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'HTML'">HTML</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'CSS'">CSS</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'AngularJS'">Angular</a></li>
          <li><a href="" v-on:click="selectedLanguage = 'Vue'">VueJS</a></li>
        </ul>
      </div>
      <div class="uk-grid uk-child-width-1-4@xl uk-child-width-1-3@l uk-child-width-1-2@m uk-child-width-1-1@s">
        <div class="uk-card uk-card-default uk-card-body" v-for="project in listOfProjects">
